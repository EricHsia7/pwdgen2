...
export function showPatternOptions(ls_key, id, event): void {
  ...
  options_elt.innerHTML += optionItemString('Edit', 0, 0, 'editpattern', 0, icons.icon_edit, `interaction.pattern_manager.removePatternOptions('${temporary_id}',event);interaction.pattern_editor.openPatternEditor('edit','${ls_key}','${temporary_id}',event)`);
